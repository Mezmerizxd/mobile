                    ...
                    {TaskCollection.map(task => (
                        <View key={task.id} style={styles.task_container}>
                            <View style={styles.task_data}>
                                ...
                                <Text style={task.completed ? styles.task_completed : styles.task_notCompleted}>{task.completed ? "Completed" : "Not Completed"}</Text>
                            </View>
                            {task.completed === false && (
                                <View style={styles.task_action}>
                                    <Pressable style={styles.tickBox} onPress={() => {
